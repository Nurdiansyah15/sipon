    ...
    public function update(Request $request, $id)
    {
        try {
            $fields = $request->validate([
                ...
                'nisn' => 'size:10|string|nullable',
                'no_kip' => 'size:6|string|nullable',
                'no_pkh' => 'size:6|string|nullable',
                'no_kks' => 'size:6|string|nullable',
                'home_status' => 'string|nullable',
                'nik' => 'size:16|string|nullable',
                'no_kk' => 'size:16|string|nullable',
